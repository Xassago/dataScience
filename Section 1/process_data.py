...
for caseid in data.keys():
    ...
    for case in cases:
        ...
        if len(records) >= 4:
            ...
            data_to_process[caseid][case["user_id"]]["program_rate"] = math.log(to_cal,
...
for caseid in data.keys():
    ...
    for case in cases:
        ...
        if len(records) >= 3:
            ...
            data_to_process[caseid][case["user_id"]]["debug_rate"] = math.log(math.sqrt(debug_rate / up_times),
